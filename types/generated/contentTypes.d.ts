...
export interface ApiCompartidoCompartido extends Struct.CollectionTypeSchema {
  collectionName: 'compartidos';
  info: {
    displayName: 'Compartido';
    pluralName: 'compartidos';
    singularName: 'compartido';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    compartido: Schema.Attribute.Component<'shared.specific-plan', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReasonReason extends Struct.CollectionTypeSchema {
...
export interface ApiResellerReseller extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reseller: Schema.Attribute.Component<'shared.specific-plan', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWordpressWordpress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wordpress: Schema.Attribute.Component<'shared.specific-plan', true>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::compartido.compartido': ApiCompartidoCompartido;
      'api::global.global': ApiGlobalGlobal;
      'api::hero.hero': ApiHeroHero;
      'api::plan.plan': ApiPlanPlan;
      'api::reason.reason': ApiReasonReason;
      'api::reseller.reseller': ApiResellerReseller;
      'api::wordpress.wordpress': ApiWordpressWordpress;
